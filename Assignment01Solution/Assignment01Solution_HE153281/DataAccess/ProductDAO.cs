...
namespace DataAccess
{
    public class ProductDAO
    {
        ...
        public static List<ProductRespond> GetProducts(string search)
        {
            var products = _context.Products.Include(p => p.Category).Select(prd => new ProductRespond
            {
        ...
        public static void SaveProduct(ProductRespond productRespond)
        {
            try
            {
        ...
        public static void UpdateProduct(int id,ProductRespond productRespond)
        {
            try
            {
